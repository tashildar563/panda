...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <!--  <li class="nav-item dropdown ml-auto">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li> <h5 class="pt-2 text-light"><?php echo "<strong>Welcome </strong>".$_SESSION['username']." !"; ?></h5></li>
    ...
    <div class="card-group mt-4" id="cards">
        <div class="card mr-3">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?php echo $_SESSION['username']; ?>A non-profit organization that brings together a diverse group (farmers, scientists, retailers, manufacturers and animal advocates) with the common goal of improving farm animal welfare standards around the world.</p>
            </div>
    ...
    <div class="jumbotron mt-3 "style="background-color:lightskyblue">
        ...
        Know More
         ...
         <a class="btn btn-primary bg-success" type="button" href="donate.php">
        Donate
    </a>
...
<div style="width:100%; height:300px; background-color:lightcoral" class="shadow">
    ...
    <div class="row mt-5" id="about">
        ...
        <div class="w-100 p-1 bg-light text-center">Handcrafted with &hearts; by ALTHAAF </div>
...
<ul class="nav navbar-nav navbar-right">
                <li> <h5 class="m-0 text-light"><a href="logout.php" >Logout</a></h5></li>
